...
| `--request-option prepare_voice_prompt_only=true` | bool | `false` | Build and cache a Base voice-clone prompt without running the talker or decoder. Intended for generic `/v1/tasks/run` preparation calls. |
